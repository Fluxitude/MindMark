...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <TooltipPrimitive.Portal>
    <TooltipPrimitive.Content
      ...
      className={cn(
        // Cult UI signature 12px border radius for tooltips
        "z-50 overflow-hidden rounded-[12px] px-3 py-2 text-sm",
        // Cult UI neomorphic background and borders
        "bg-neutral-50 dark:bg-neutral-800 text-foreground border border-white/60 dark:border-neutral-700/50",
        ...
        // Enhanced shadow for floating tooltips
